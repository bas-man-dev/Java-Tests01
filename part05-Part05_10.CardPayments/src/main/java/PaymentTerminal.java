...
public class PaymentTerminal {
    ...
    private int soldAffordable; // number of sold affordable meals
    private int soldHearty;  // number of sold hearty meals
    ...
    public String toString() {
        return "money: " + money + ", number of sold affordable meals: " + this.soldAffordable + ", number of sold hearty meals: " + this.soldHearty;
    }
}
